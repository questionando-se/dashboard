...
function openLists(id) {
    ...
    win.document.head.innerHTML = '<meta charset="UTF-8" />\n<meta name="viewport" content="width=device-width, initial-scale=1.0" />\n<title>' + exam.name + '</title>'
        ...
        + '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/questionando-se/dashboard@0.0.14/styles/question.css" />'
        + '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/questionando-se/dashboard@0.0.14/styles/userExams/list.css" />';
